package com.bison.quartz.service.impl;

import cc.mrbird.common.annotation.CronTag;
import cc.mrbird.common.service.impl.BaseService;
import com.bison.quartz.dao.JobMapper;
import com.bison.quartz.domain.Job;
import com.bison.quartz.service.JobService;
import com.bison.quartz.util.ScheduleUtils;
...
public class JobServiceImpl extends BaseService<Job> implements JobService {
    ...
    public List<Job> getSysCronClazz(Job job) {
        Reflections reflections = new Reflections("cc.mrbird.quartz.task");
